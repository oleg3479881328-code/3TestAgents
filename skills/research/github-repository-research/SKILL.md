...
| Assumption | Why it is not confirmed | Needed evidence |
|---|---|---|
| TBD | TBD | TBD |

## Reusable Patterns

| Pattern | Evidence | Usefulness | Portability | Implementation Effort | Risk |
|---|---|---|---|---|---|
| TBD | TBD | TBD | TBD | TBD | TBD |

## Adaptation Recommendations

| Pattern | How to adapt | What to avoid |
|---|---|---|
| TBD | TBD | TBD |
